        ...
        if(self){
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
              ...
              //  NSString *apiId = [config objectForKey:@"apiId"];
                NSString *apiId = @"RCH4GZ21MFGQXFLY66KN12XK";
                ...
                if(anonymousId != nil){
                    NSLog(@"Anonymous ID :  %@",anonymousId);
            ...
            if(properties != nil){
                ...
                for (NSString* key in properties.allKeys) {
                    ...
                    if ([val isKindOfClass:[NSString class]]){
                        NSDate* converted_date = [self dateFromISOdateStr:val];
    ...
    -(void)identifyDateUserAttribute:(id)value withKey:(NSString*)attr_name{
        if ([value isKindOfClass:[NSString class]]) {
            NSDate* converted_date = [self dateFromISOdateStr:value];
            if (converted_date != nil) {
